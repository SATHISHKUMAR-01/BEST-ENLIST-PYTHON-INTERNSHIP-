##### A MANUAL ABOUT MY GUI INTERFACE HOW TO USE IT #####
##### FIRST ON , THE COFFEE MACHINE #####
##### THEN ENTER THE CHOICE OF YOUR COFFEE IN THE TEXTBOX #####
##### THEN THE REPORT ABOUT COFFEE MACHINE WILL BE SHOWN #####
##### THEN PRESS THE RADIO BUTTON TO CHOOSE YOUR INGREDIENTS #####
##### ENTER YOUR REQUIRED QUANTITY OF RESOURCES IN TEXT BOX #####
##### THE COST OF COFFEE IS SHOWN #####
##### THEN PRESS THE OK RADIO BUTTON TO ENTER THE MONEY #####
##### ENTER THE SUFFICIENT MONEY IN THE TEXT BOX #####
##### THAT'S ALL YOUR COFFEE IS READY ..... ENJOY IT ######

from tkinter import * 

m = Tk()

m.title("KOFFEE KICKS")
